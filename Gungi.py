...
board = pygame.image.load("./Pictures/Board.jpg").convert()
...
NinjaB = pygame.image.load("./Pictures/NinjaB.png").convert_alpha()
NinjaW = pygame.image.load("./Pictures/NinjaW.png").convert_alpha()
...
Ninja_B = pygame.image.load("./Pictures/Ninja_B.png").convert_alpha()
Ninja_W = pygame.image.load("./Pictures/Ninja_W.png").convert_alpha()
...
while loop==1:
    ...
    for event in pygame.event.get():
            ...
            if event.type == KEYDOWN and event.key == K_h:
                rules = pygame.image.load("./Pictures/help_1.png").convert()
                    ...
                    for event in pygame.event.get():  
                        if event.type == MOUSEBUTTONDOWN and event.button == 1:
                            ...
                            if posx>1080 and posy<120:
                                ...
                                page += 1
                                if page == 2:
                                    rules = pygame.image.load("./Pictures/help_2.png").convert()
                                if page == 3:
                                    rules = pygame.image.load("./Pictures/help_3.png").convert()
                                if page == 4:
                                    rules = pygame.image.load("./Pictures/help_4.png").convert()
                                if page == 5:
                                    rules = pygame.image.load("./Pictures/help_5.png").convert()
                                if page == 6:
                                    rules = pygame.image.load("./Pictures/help_6.png").convert()
                                screen.blit(rules, (0,0))
                                pygame.display.flip()
                display()
            #Left Mouse Click
